    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\ImageColumn::make('image')->disk('images')->label(__('medicine_fields.image'))->toggleable(),
                ...
                Tables\Columns\TextColumn::make('manufacturer')->label(__('medicine_fields.manufacturer'))->icon('heroicon-o-building-office')->iconColor('primary')->toggleable(),
