...
<body style="background-color: #f8fafc; font-family: sans-serif; color: #2d3748;">
    <div
        ...
        <h1 style="font-size: 24px; font-weight: 600; color: #ffffff; margin-bottom: 16px;">Important Medication Alert
        </h1>
        <p style="font-size: 18px; margin-bottom: 16px; color: #ffffff;">The Alert Content:</p>
        <p style="padding: 16px; border-radius: 8px; color: #2d3748; font-weight: bold;">{{ $messageBody }}</p>
        <div style="margin-top: 24px;">
            <p style="font-size: 14px; color: #ffffff;">Thanks,</p>
